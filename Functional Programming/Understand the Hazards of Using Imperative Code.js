...
but the output will be slightly different. Work through the code and see if you can figure 
out the problem, then advance to the next challenge to learn more.
 */
...
//Lets' create threee browser windows
var workWindow = new Window(['Gmail', 'Inbox', 'Work mail', 'Docs', 'freeCodeCamp']);
// Your mailbox, dirve, and other work sites
...
var finalTabs = socialWindow
                    .tabOpen() //Open a new tab for cart memes
